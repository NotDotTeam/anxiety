...
b: Поэтому ему нужен был дешёвый способ создания железнодорожных туннелей. Поэтому он изобрел новый материал под названием "динамит"...
...
b: Думаешь, ты в безопасности только потому, что вынула батареи из детектора угарного газа?
...
[Ты проверила пунш перед тем, как его выпить?](#act2c_punch)
...
h: *Я любима. Я хороша. Я умна. Я потрясающая. Я особенная.*
...
b: Экспериментатор не знал, кто был в какой группе.

`bb({body:"two_up", mouth:"small", eyes:"normal_r"})`

b: Результаты таковы: если у тебя уже была низкая самооценка, просьба повторить заставляет тебя чувствовать себя *хуже*, чем если бы ты вообще ничего не сказал!
...
b: Коренные американцы - это *настоящие люди*, а не "благородные дикари", как ты их называешь, чтобы сделать своё предсказание из печеньки более *экзотическим*.
...
b: ХВАТИТ БЫТЬ РАСИСТКОЙ, ТЫ, УЗКОГЛАЗАЯ ДУРА
...
h: Так почему я должна слушать бесполезный, иррациональный, несуществующий кусок ^дерьма^, как ты?!
...
b: Так что, если я - "просто нейрохимикаты", значит *я* - иррациональный... значит, *ты* - иррациональна!
...
b: Подожди... "они" говорят, что чувства верны, что ты всегда должна принимать свои эмоции.
...
b: Ну, может быть, ты НЕ *ДОЛЖНА* ИЗБАВЛЯТЬСЯ ОТ МЕНЯ.
...
b: Я просто... всё, чего я хочу, так это чтобы ты была терпелива со мной.

`bb({eyes:"cry_r_3"});`

b: Я просто хочу, чтобы ты посидела со мной немного, вместо того, чтобы отвернуться и--
...
r: Похоже, ты пытаешься воевать сама с собой, малыш.
...
r: Эй. Ты не одна, подруга. Тревожность супер нормальна.
...
[Это плохая копинговая стратегия.](#act2g_2) `Game.OVERRIDE_CHOICE_LINE=true`
...
h: Я МОГЛА *ВИДЕТЬ* СВОЙ  ТРУП. Я МОГЛА *ЧУВСТВОВАТЬ*, КАКОВО БЫТЬ МЁРТВЫМ ПО-НАСТОЯЩЕМУ.
{{/if}}

{{if _.SPECIAL_ATTACK=="alone"}}
h: Я МОГЛА *ВИДЕТЬ* ИХ ОТВРАЩЕНИЕ. Я МОГЛА *СЛЫШАТЬ* ВСЁ, ЧТО ОНИ ВСЕ ГОВОРЯТ.
{{/if}}

{{if _.SPECIAL_ATTACK=="bad"}}
h: Я МОГЛА *СЛЫШАТЬ* ХРУСТ РЁБЕР. Я МОГУ *ЧУВСТВОВАТЬ* КРОВЬ В ВОЗДУХЕ.
{{/if}}
